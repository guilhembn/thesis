...
Another method to select the robot actions that yet needs to be implemented is to consider the human as being able to plan a few step ahead. Thus, instead of considering the average cost of all the possible human actions, we could set less importance to the ones failing a few steps ahead and more importance to the ones leading to a smaller cost in the near future.
